...
public class RailSmeltingMod {
	...
	public RailSmeltingMod() {
		...
		MinecraftForge.EVENT_BUS.register(new RailSmeltingModFMLBusEvents(this));
	}
	...
	private static class RailSmeltingModFMLBusEvents {
		private final RailSmeltingMod parent;

		RailSmeltingModFMLBusEvents(RailSmeltingMod parent) {
			this.parent = parent;
		}
