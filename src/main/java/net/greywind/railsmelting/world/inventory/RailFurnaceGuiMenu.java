...
import net.greywind.railsmelting.procedures.RailFurnaceGuiWhenOpenProcedure;
...
public class RailFurnaceGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RailFurnaceGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RailSmeltingModMenus.RAIL_FURNACE_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 41, 12) {
			private final int slot = 0;
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 113, 12) {
