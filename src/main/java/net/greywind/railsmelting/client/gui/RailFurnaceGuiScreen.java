...
public class RailFurnaceGuiScreen extends AbstractContainerScreen<RailFurnaceGuiMenu> {
	...
	public RailFurnaceGuiScreen(RailFurnaceGuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("rail_smelting:textures/screens/rail_furnace_gui.png");
